...
from .models import AdminType, Permission, User
...
class DuplicateUserCheckAPITest(APITestCase):
    def setUp(self):
        ...
        user.phone = "13695228699"
        user.save()
        self.url = self.reverse("check_username_or_email_or_phone")
...
class UserChangeEmailAPITest(APITestCase):
    def setUp(self):
        ...
        self.new_phone = '13695228699'
        self.data = {"password": "test123", "new_email": self.new_mail, 'new_phone' : self.new_phone}

    def test_change_email_and_phone_success(self):
        resp = self.client.post(self.url, data=self.data)
        self.assertSuccess(resp)
...
class AdminUserTest(APITestCase):
    def setUp(self):
        ...
        self.data = {"id": self.regular_user.id, "username": self.username, "real_name": "test_name",
                     ...
                     "phone": "13695228699",
                     "problem_permission": Permission.OWN, "open_api": True,
    ...
    def test_edit_user_successfully(self):
        ...
        self.assertEqual(resp_data["phone"], "13695228699")
        ...
        self.assertEqual(resp_data["problem_permission"], Permission.NONE)
    ...
    def test_import_duplicate_user(self):
        ...
        resp = self.client.post(self.url, data)
        self.assertFailed(resp, "DETAIL:  键值\"(username)=(user1)\" 已经存在")
        # no user is created
