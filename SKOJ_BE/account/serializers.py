...
from .models import AdminType, Permission, User, UserProfile, Clue
...
class UsernameOrEmailOrPhoneCheckSerializer(serializers.Serializer):
...
class UserAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "phone", "admin_type", "problem_permission", "course_permission", "real_name",
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ["id", "username", "email", "phone", "admin_type", "problem_permission", "course_permission",
                  "create_time", "last_login", "two_factor_auth", "open_api", "is_disabled"]
...
class EditUserSerializer(serializers.Serializer):
    ...
    email = serializers.EmailField(max_length=64)
    phone = serializers.CharField()
    admin_type = serializers.ChoiceField(choices=(AdminType.REGULAR_USER, AdminType.ADMIN, AdminType.SUPER_ADMIN, AdminType.TEACHER_RESEARCHER, AdminType.LECTURER, AdminType.SCHOOL_MANAGER))
    problem_permission = serializers.ChoiceField(choices=(Permission.NONE, Permission.OWN,
                                                          Permission.ALL))
    course_permission = serializers.ChoiceField(choices=(Permission.NONE, Permission.OWN,
                                                          Permission.ALL))
...
class ClueSerializer(serializers.ModelSerializer):
    student_name = serializers.CharField(max_length=256, allow_blank=False, required=True)
    phone = serializers.CharField(required=True)
    xiaoe_phone = serializers.CharField(required=False)
    id = serializers.IntegerField()
