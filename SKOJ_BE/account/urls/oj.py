...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI,
                        ...
                        UserLoginAPI, UserLogoutAPI, UsernameOrEmailOrPhoneCheck,UserChangePhoneAPI,
...
urlpatterns = [
    ...
    url(r"^change_phone/?$", UserChangePhoneAPI.as_view(), name="user_change_phone_api"),
    ...
    url(r"^check_username_or_email_or_phone", UsernameOrEmailOrPhoneCheck.as_view(), name="check_username_or_email_or_phone"),
