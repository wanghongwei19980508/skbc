...
from ..views import ReleaseNotesAPI, DashboardInfoAPI, SoftwaresAdminAPI, SlideshowsAdminAPI, ClearSWPicCached
...
urlpatterns = [
    ...
    url(r"^softwares/?$", SoftwaresAdminAPI.as_view(), name="softwares_admin_api"),
    url(r"^slideshows/?$", SlideshowsAdminAPI.as_view(), name="slideshows_admin_api"),
    url(r"^clearSWPicCached/?$", ClearSWPicCached.as_view(), name="clear_software_pic_cached_api"),
]
