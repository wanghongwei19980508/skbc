...
class AnnouncementAdminTest(APITestCase):
    ...
    def create_announcement(self):
        return self.client.post(self.url, data={"title": "test", "content": "test", "visible": True, "top":True})
    ...
    def test_edit_announcement(self):
        ...
        self.assertEqual(resp_data["top"], False)
...
class AnnouncementAPITest(APITestCase):
    def setUp(self):
        self.user = self.create_super_admin()
        Announcement.objects.create(title="title", content="content", visible=True, created_by=self.user, top = True)
