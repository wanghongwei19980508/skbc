export const m = {
  ...
  Choice_can_not_be_empty: 'Choice can not be empty',
  ...
  Objective_Problem_List: 'Objective Problem List',
  No_Problems: 'No Problems',
  No_Objective_Problems: 'No Objective Problems',
  // CodeMirror.vue
  Language: 'Language',
  Theme: 'Theme',
