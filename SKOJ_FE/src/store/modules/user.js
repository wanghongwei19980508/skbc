...
import { STORAGE_KEY, USER_TYPE, PROBLEM_PERMISSION, COURSE_PERMISSION } from '@/utils/constants'
...
const getters = {
  ...
  hasCoursePermission: (state, getters) => {
    return getters.user.course_permission !== COURSE_PERMISSION.NONE
  }
}
