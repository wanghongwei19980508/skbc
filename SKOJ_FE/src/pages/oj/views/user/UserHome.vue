      ...
      <div v-if="profile.user">
        <p style="margin-top: -10px">
          <span v-if="profile.user" class="emphasis">{{
            profile.real_name != null ? profile.real_name : profile.user.username
          }}</span>
        ...
        <div id="problems">
          <div v-if="problems.length">
            ...
            <Poptip v-if="refreshVisible" trigger="hover" placement="right-start">
              ...
              <div slot="content">
                <p>
                  If you find the following problem id does not exist,<br />
          ...
          <div class="btns">
            <div class="problem-btn" v-for="problemID of problems" :key="problemID">
              <Button type="ghost" @click="goProblem(problemID)">{{
                problemID
              }}</Button>
            </div>
          </div>
        ...
        <div id="icons">
          <a :href="profile.github" v-if="profile.github != null">
            <Icon type="social-github-outline" size="30"></Icon>
          </a>
          <Icon type="social-github-outline" size="30" v-else></Icon>
          <a :href="'mailto:' + profile.user.email" v-if="profile.user.email != null">
            <Icon class="icon" type="ios-email-outline" size="30"></Icon>
          </a>
          <Icon class="icon" type="ios-email-outline" size="30" v-else></Icon>
          <a :href="profile.blog" v-if="profile.blog != null">
            <Icon class="icon" type="ios-world-outline" size="30"></Icon>
          </a>
          <Icon class="icon" type="ios-world-outline" size="30" v-else></Icon>
        </div>
      </div>
    </Card>
  </div>
