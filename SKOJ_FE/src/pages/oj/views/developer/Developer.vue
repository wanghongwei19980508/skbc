            ...
            <div id="problem-content" class="markdown-body" v-katex>
              <Row>
                <el-tooltip
                  ...
                  :content="$t('m.Time_Limit')"
                >
                  <Col :span="6">
                    <div v-html="problem.time_limit + 'ms'"></div>
                  </Col>
                </el-tooltip>
                <el-tooltip
                  placement="bottom-start"
                  :content="$t('m.Memory_Limit')"
                >
                  <Col :span="6">
                    <div v-html="problem.memory_limit + 'ms'"></div>
                  </Col>
                </el-tooltip>
                <el-tooltip placement="bottom-start" :content="$t('m.IOMode')">
                  <Col :span="6">
                    <div v-html="problem.io_mode.io_mode"></div>
                  </Col>
                </el-tooltip>
                <el-tooltip placement="bottom-start" :content="$t('m.Level')">
                  <Col :span="6">
                    <div v-html="$t('m.' + problem.difficulty)"></div>
                  </Col>
                </el-tooltip>
              </Row>
  ...
  <!-- <div class="flex-container">
    <div id="problem-main">
      <Row>
        ...
        <Col :span="2" :offset="1">
          <vue-affix-box :offset-top="80" id="right-column">
                ...
                <li>
                  ...
                  <p>
                    <Poptip trigger="hover" placement="left-end">
                      <a>{{ $t("m.Show") }}</a>
                      <div slot="content">
                        <Tag v-for="tag in problem.tags" :key="tag">{{
                          tag
                        }}</Tag>
                      </div>
                    </Poptip>
