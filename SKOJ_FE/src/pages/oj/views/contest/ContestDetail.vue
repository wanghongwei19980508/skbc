  ...
  <div class="flex-container">
    ...
    <div v-show="showMenu" id="contest-menu">
      <VerticalMenu @on-click="handleRoute">
        ...
        <VerticalMenu-item :disabled="contestMenuDisabled"
          :route="{ name: 'contest-topic-list', params: { contestID: contestID } }">
        ...
        <!-- <VerticalMenu-item :disabled="contestMenuDisabled"
          :route="{ name: 'contest-objective-problem-list', params: { contestID: contestID } }">
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            let str = params.row.contest_type ? params.row.contest_type.replace(' ', '_') : ''
            return h('span', this.$i18n.t('m.' + str))
          }
        },
        {
