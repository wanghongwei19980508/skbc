...
import { applicationStatusTableColumn, applicationStatusHeaderForm } from './../config.js'
...
export default {
  ...
  data() {
    return {
      ...
      tableColumn: applicationStatusTableColumn,  // 表格页头
      headerForm: applicationStatusHeaderForm, // 表格搜索栏
    };
  },
  mounted() {
