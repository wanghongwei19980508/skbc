...
<template>
  <div class="baseInfo">
    <vTable ref="tableRef" :height="'calc(100vh -  ' + (320 + 47 * tableLength) + 'px)'" :tableColumn="tableColumn"
      :tableData="tableData" :tableTotal="tableTotal" :headerForm=headerForm @tableChange="tableChange"
...
import { studentInSchoolListTableColumn, studentInSchoolListHeaderForm } from './../config.js'
import { mapGetters } from 'vuex'

export default {
  name: "studentInSchoolList",
  components: {
    vTable,
  },
  data() {
    return {
      ...
      tableColumn: studentInSchoolListTableColumn,  // 表格页头
      // 表格操作
      headerForm: studentInSchoolListHeaderForm, // 表格搜索栏
    };
  },
  mounted() {
