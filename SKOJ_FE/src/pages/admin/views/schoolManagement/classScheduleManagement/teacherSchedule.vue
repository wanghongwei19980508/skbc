    ...
    <div id="actionBar" class="actionBar"
      ...
      <div class="info-top">
        ...
        <div class="info-item">
          ...
          <el-progress v-if="classOptions.studentNum"
            :percentage="classOptions.studentNum / classOptions.classCapacity * 100"></el-progress>
        </div>
  ...
  data() {
    return {
      ...
      calendarOptions: { // 日历配置
        ...
        initialView: 'resourceTimelineWeek', // 默认为那个视图（月：dayGridMonth，周：timeGridWeek，日：timeGridDay）
        resourceAreaHeaderContent: '老师',
        resourceAreaWidth: '12em',
        ...
        headerToolbar: { // 日历头部按钮位置
          ...
          right: 'resourceTimelineWeek' //today resourceTimelineDay,
        },
        buttonText: { // 按钮对应显示
          // today: '今天',
        ...
        datesSet: this.handleDatesRender, // 切换视图事件
        ...
        resources: [
          { id: 1, title: "xxx老师", eventColor: this.coloring() },
          // { id: 1.1, title: " ", eventColor: this.coloring() },
          { id: 2, title: "ttt老师", eventColor: this.coloring() },
        ],
        events: [
          {
            id: 1,
