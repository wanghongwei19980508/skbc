        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-descriptions class="margin-top" :column="2" border>
              <el-descriptions-item :label="$t('m.IP')">
                <el-tag type="success">{{ props.row.ip }}</el-tag>
              </el-descriptions-item>
              <el-descriptions-item :label="$t('m.Judger_Version')">
                <el-tag type="success">{{ props.row.judger_version }}</el-tag>
              </el-descriptions-item>
              <el-descriptions-item :label="$t('m.Service_URL')">
                <code>{{ props.row.service_url }}</code>
              </el-descriptions-item>
              <el-descriptions-item :label="$t('m.Last_Heartbeat')">
                <code>{{ props.row.last_heartbeat | localtime }}</code>
              </el-descriptions-item>
              <el-descriptions-item :label="$t('m.Create_Time')">
                <code>{{ props.row.create_time | localtime }}</code>
              </el-descriptions-item>
            </el-descriptions>
          </template>
        </el-table-column>
